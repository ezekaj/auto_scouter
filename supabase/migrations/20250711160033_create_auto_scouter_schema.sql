...
CREATE INDEX IF NOT EXISTS idx_vehicle_listings_make ON vehicle_listings(make);
CREATE INDEX IF NOT EXISTS idx_vehicle_listings_model ON vehicle_listings(model);
CREATE INDEX IF NOT EXISTS idx_vehicle_listings_price ON vehicle_listings(price);
CREATE INDEX IF NOT EXISTS idx_vehicle_listings_year ON vehicle_listings(year);
CREATE INDEX IF NOT EXISTS idx_vehicle_listings_mileage ON vehicle_listings(mileage);
CREATE INDEX IF NOT EXISTS idx_vehicle_listings_city ON vehicle_listings(city);
CREATE INDEX IF NOT EXISTS idx_vehicle_listings_source ON vehicle_listings(source_website);
CREATE INDEX IF NOT EXISTS idx_vehicle_listings_active ON vehicle_listings(is_active);
CREATE INDEX IF NOT EXISTS idx_vehicle_listings_scraped ON vehicle_listings(scraped_at);
CREATE INDEX IF NOT EXISTS idx_vehicle_listings_duplicate ON vehicle_listings(is_duplicate);
...
CREATE INDEX IF NOT EXISTS idx_alerts_criteria ON alerts(make, model, min_price, max_price);
CREATE INDEX IF NOT EXISTS idx_alerts_location ON alerts(city, region);
...
CREATE INDEX IF NOT EXISTS idx_scraping_sessions_website ON scraping_sessions(source_website);
